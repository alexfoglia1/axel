...
#define RF_READ_CR_0(DST) asm volatile("mov %%cr0, %0" : "=r" (DST))
#define RF_READ_CR_1(DST) asm volatile("mov %%cr1, %0" : "=r" (DST))
#define RF_READ_CR_2(DST) asm volatile("mov %%cr2, %0" : "=r" (DST))
#define RF_READ_CR_3(DST) asm volatile("mov %%cr3, %0" : "=r" (DST))

#define RF_READ_GENERAL_A_32(DST) asm volatile("mov %%eax, %0" : "=r" (DST))
#define RF_READ_GENERAL_B_32(DST) asm volatile("mov %%ebx, %0" : "=r" (DST))
#define RF_READ_GENERAL_C_32(DST) asm volatile("mov %%ecx, %0" : "=r" (DST))
#define RF_READ_GENERAL_D_32(DST) asm volatile("mov %%edx, %0" : "=r" (DST))
...
#define RF_WRITE_CR_0(DST) asm volatile("mov %0, %%cr0" :: "r" (DST))
#define RF_WRITE_CR_1(DST) asm volatile("mov %0, %%cr1" :: "r" (DST))
#define RF_WRITE_CR_2(DST) asm volatile("mov %0, %%cr2" :: "r" (DST))
#define RF_WRITE_CR_3(DST) asm volatile("mov %0, %%cr3" :: "r" (DST))

#define RF_WRITE_GENERAL_A_32(DST) asm volatile("mov %0, %%eax" :: "r" (DST))
#define RF_WRITE_GENERAL_B_32(DST) asm volatile("mov %0, %%ebx" :: "r" (DST))
#define RF_WRITE_GENERAL_C_32(DST) asm volatile("mov %0, %%ecx" :: "r" (DST))
#define RF_WRITE_GENERAL_D_32(DST) asm volatile("mov %0, %%edx" :: "r" (DST))
